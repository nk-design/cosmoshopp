...
export const metadata = {
    title: "COSMOSHOPP - Магазин брендової косметики, сторінка відновлення паролю", // Page title
    description: "На цій сторінці ви можете змінити свій пароль, якщо ви його забули", // Meta description
    robots: "index, follow", // Robots directives (optional)
    canonical: "https://www.cosmoshopp.com/forgot", // Canonical URL
    icons: {
    ...
    openGraph: {
      title: "COSMOSHOPP - Магазин брендової косметики, сторінка відновлення паролю", // OG title
      description: "На цій сторінці ви можете змінити свій пароль, якщо ви його забули", // OG description
      url: "https://www.cosmoshopp.com/forgot", // OG URL
    ...
    twitter: {
      ...
      title: "COSMOSHOPP - Магазин брендової косметики, сторінка відновлення паролю", // Twitter title
      description: "На цій сторінці ви можете змінити свій пароль, якщо ви його забули", // Twitter description
