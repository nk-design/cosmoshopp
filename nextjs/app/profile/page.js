...
export const metadata = {
    title: "COSMOSHOPP - Магазин брендової косметики, сторінка профілю", // Page title
    description: "На цій сторінці ви можете редагувати свій профіль, побачити свої замовлення або видалити свій аккаунт", // Meta description
    robots: "index, follow", // Robots directives (optional)
    canonical: "https://www.cosmoshopp.com/profile", // Canonical URL
    icons: {
    ...
    openGraph: {
      title: "COSMOSHOPP - Магазин брендової косметики, сторінка профілю", // OG title
      description: "На цій сторінці ви можете редагувати свій профіль, побачити свої замовлення або видалити свій аккаунт", // OG description
      url: "https://www.cosmoshopp.com/profile", // OG URL
    ...
    twitter: {
      ...
      title: "COSMOSHOPP - Магазин брендової косметики, сторінка профілю", // Twitter title
      description: "На цій сторінці ви можете редагувати свій профіль, побачити свої замовлення або видалити свій аккаунт", // Twitter description
