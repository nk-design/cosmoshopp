...
export async function generateMetadata(){
    return {
        title: "COSMOSHOPP - Магазин брендової косметики, сторінка реєстрації", // Page title
        description: "На цій сторінці ви можете створити собі профіль та скористуватись нашими спеціальними пропозиціями", // Meta description
        robots: "index, follow", // Robots directives (optional)
        canonical: "https://www.cosmoshopp.com/register", // Canonical URL
        icons: {
        ...
        openGraph: {
        title: "COSMOSHOPP - Магазин брендової косметики, сторінка реєстрації", // OG title
        description: "На цій сторінці ви можете створити собі профіль та скористуватись нашими спеціальними пропозиціями", // OG description
        url: "https://www.cosmoshopp.com/register", // OG URL
        ...
        title: "COSMOSHOPP - Магазин брендової косметики, сторінка реєстрації", // Twitter title
        description: "На цій сторінці ви можете створити собі профіль та скористуватись нашими спеціальними пропозиціями", // Twitter description
