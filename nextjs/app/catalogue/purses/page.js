...
export const metadata = {
    title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту косметичок", // Page title
    ...
    canonical: "https://www.cosmoshopp.com/catalogue/purses", // Canonical URL
    icons: {
    ...
    openGraph: {
      title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту косметичок", // OG title
      ...
      url: "https://www.cosmoshopp.com/catalogue/purses", // OG URL
    ...
    twitter: {
      ...
      title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту косметичок", // Twitter title
...
const CataloguePage = () => {
    return <Catalogue type="purses" pathName="Косметички"/>
}
