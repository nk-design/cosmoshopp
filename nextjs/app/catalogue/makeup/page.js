...
export const metadata = {
    title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту засобів для макіяжу", // Page title
    ...
    canonical: "https://www.cosmoshopp.com/catalogue/makeup", // Canonical URL
    icons: {
    ...
    openGraph: {
      title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту засобів для макіяжу", // OG title
      ...
      url: "https://www.cosmoshopp.com/catalogue/makeup", // OG URL
    ...
    twitter: {
      ...
      title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту засобів для макіяжу", // Twitter title
...
const CataloguePage = () => {
    return <Catalogue type="makeup" pathName="Макіяж"/>
}
