...
export const metadata = {
    title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту свічок", // Page title
    ...
    canonical: "https://www.cosmoshopp.com/catalogue/candles", // Canonical URL
    icons: {
    ...
    openGraph: {
      title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту свічок", // OG title
      ...
      url: "https://www.cosmoshopp.com/catalogue/candles", // OG URL
    ...
    twitter: {
      ...
      title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту свічок", // Twitter title
...
const CataloguePage = () => {
    return <Catalogue type="candles" pathName="Свічки"/>
}
