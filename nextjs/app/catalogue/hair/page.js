...
export const metadata = {
    title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту засобів для волосся", // Page title
    ...
    canonical: "https://www.cosmoshopp.com/catalogue/hair", // Canonical URL
    icons: {
    ...
    openGraph: {
      title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту засобів для волосся", // OG title
      ...
      url: "https://www.cosmoshopp.com/catalogue/hair", // OG URL
    ...
    twitter: {
      ...
      title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту засобів для волосся", // Twitter title
...
const CataloguePage = () => {
    return <Catalogue type="hair" pathName="Волосся"/>
}
