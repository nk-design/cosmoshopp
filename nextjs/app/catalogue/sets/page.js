...
export const metadata = {
    title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту наборів", // Page title
    ...
    canonical: "https://www.cosmoshopp.com/catalogue/sets", // Canonical URL
    icons: {
    ...
    openGraph: {
      title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту наборів", // OG title
      ...
      url: "https://www.cosmoshopp.com/catalogue/sets", // OG URL
    ...
    twitter: {
      ...
      title: "COSMOSHOPP - Магазин брендової косметики, сторінка каталогу нашого асортименту наборів", // Twitter title
...
const CataloguePage = () => {
    return <Catalogue type="sets" pathName="Набори"/>
}
